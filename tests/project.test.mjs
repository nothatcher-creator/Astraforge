...
test('bundled project preserves asset bytes, fonts, words and keyframes', async () => {
  ...
  p.assets = [{ id: 'font', name: 'Font.ttf', type: 'font', mime: 'font/ttf', size: 4, fontFamily: 'Project Serif', source: {url:'https://example.com/font',provider:'Example',creator:'Author',license:'OFL',licenseUrl:'https://example.com/OFL.txt',licenseText:'Font license text'} }];
  ...
  try {
    ...
    assert.match(strFromU8(archive['CREDITS.txt']),/Font license text/);
